...
// #define TRANSMISSION_THRESHOLD 2
...
// void convertArrayToString(const uint8_t* array, size_t size, String& result);
...
//       <html>
//       <head>
//         <title>ESP32 String Display</title>
//         <script>
...
//       if (stringUpdated) {
//         Serial.println("String updated");
//         stringUpdated = false;
//         String sseMessage = "data: " + sendString + "\n\n";
//         size_t len = sseMessage.length();
//         if (len > maxLen) {
//             Serial.println("Warning: sseMessage is larger than buffer size, truncating...");
//             len = maxLen; // Prevent overflow by limiting to maxLen
//         }
//         Serial.println("About to memcpy");
//         memcpy(buffer, sseMessage.c_str(), len);
//         Serial.println("Just memcpied");
//         return len;
//       }
//       return 0; // No update to send
//     });
//     Serial.println("Just created the response pointer?");
...
//                         sendString = "";
//                         convertArrayToString(responseBuffer, sizeof(responseBuffer), sendString);
//                         Serial.println("Updated String");
...
//         if(messageData[addressIndex][messageIndex].data[i+j]>=TRANSMISSION_THRESHOLD){
//             return true;
//         }
//     }}
//     }
...
//     result = "";  // Clear the String object to ensure it's empty

//     for (size_t i = 0; i < size; ++i) {
//         result += String(array[i]);  // Convert number to String and append

//         if (i < size - 1) {
//             result += ",";  // Add comma after every element except the last one
//         }
//     }
...
// //                         String sendString = "";
// //                         convertArrayToString(responseBuffer, sizeof(responseBuffer), sendString);
// //                         Serial.print("What we're sending: ");
// //                         Serial.println(sendString);
// //                         client->text(sendString);
